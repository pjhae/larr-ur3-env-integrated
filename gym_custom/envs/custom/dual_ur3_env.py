...
####
    ...
    def _get_obs(self):
        '''overridable method'''
        return np.concatenate([self.curr_pos, self.curr_pos_block,
...
####
    ...
    def step(self, a):
        ...
        self.curr_pos_block = np.concatenate([self.sim.data.geom_xpos[id_cube_1][:2], self.sim.data.geom_xpos[id_cube_4][:2]])
